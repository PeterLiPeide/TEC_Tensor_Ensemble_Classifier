...
Df = loadmat('C:\\Users\\kira2\\Desktop\\TEC_Full_Code\\Simu_Df_F4.mat')
X1 = Df['Class_1']
X2 = Df['Class_2']
...
for i in range(100):
    ...
    m1.fit('Gaussian', [0.0001, 1, 1], 1 / 160)
    m2.fit('Gaussian', [0.0001, 1, 1], 0.5)  # Notice the C parameter has different meaning in SQHinge and Hinge Solver
    m3.fit('Gaussian', [0.0001, 1, 1], 1 / 160)
    m4.fit('Gaussian', [0.0001, 1, 1], 0.5)
...
df.to_csv('F4_Result.csv', index=False)
# %%
